...
- **Color-code** groups (blue, green, yellow, orange, red, purple — all theme-aware)
...
- [`CLAUDE.md`](CLAUDE.md) — architecture overview and the host↔webview contract (concise, English)
- [`ARCHITECTURE.md`](ARCHITECTURE.md) — the full model + update-loop reference
- [`docs/INDEX.md`](docs/INDEX.md) — didactic guide (in Spanish)
- Per-directory `AGENT.md` files under `src/` — module-level invariants and patterns
